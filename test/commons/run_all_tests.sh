...
if [ "$RUN_LIFECYCLE" = true ]; then
    ...
    run_test "Recurring Spend Hook Gates"  "recurring_spend_hook_gates_test.sh"
    run_test "Recurring Spend Session Visibility" "recurring_spend_session_visibility_test.sh"
