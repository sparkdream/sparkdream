		...
		Query: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					Short:          "Query anonymous posting metadata for a post",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "post_id"}},
				},
				{
					RpcMethod:      "AnonymousReplyMeta",
					Use:            "anonymous-reply-meta [reply-id]",
					Short:          "Query anonymous posting metadata for a reply",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "reply_id"}},
				},
				{
					RpcMethod:      "IsNullifierUsed",
					Use:            "is-nullifier-used [nullifier-hex]",
					Short:          "Check if a nullifier has been used",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "nullifier_hex"}},
					FlagOptions: map[string]*autocliv1.FlagOptions{
						"domain": {Name: "domain", Usage: "nullifier domain (1 = post, 2 = reply)"},
						"scope":  {Name: "scope", Usage: "nullifier scope (epoch or post_id)"},
					},
				},
				{
		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					Use:            "create-anonymous-post [title] [body]",
					Short:          "Create an anonymous post with ZK proof",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "title"}, {ProtoField: "body"}},
					FlagOptions: map[string]*autocliv1.FlagOptions{
						"content_type":    {Name: "content-type", Usage: "content type"},
						"proof":           {Name: "proof", Usage: "ZK proof bytes (hex)"},
						"nullifier":       {Name: "nullifier", Usage: "nullifier bytes (hex)"},
						"merkle_root":     {Name: "merkle-root", Usage: "trust tree root bytes (hex)"},
						"min_trust_level": {Name: "min-trust-level", Usage: "proven minimum trust level"},
					},
				},
				{
					RpcMethod:      "CreateAnonymousReply",
					Use:            "create-anonymous-reply [post-id] [body]",
					Short:          "Create an anonymous reply with ZK proof",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "post_id"}, {ProtoField: "body"}},
					FlagOptions: map[string]*autocliv1.FlagOptions{
						"content_type":    {Name: "content-type", Usage: "content type"},
						"proof":           {Name: "proof", Usage: "ZK proof bytes (hex)"},
				...
				},
				{
					...
					Use:            "anonymous-react [post-id] [reaction-type]",
					Short:          "Add an anonymous reaction with ZK proof",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "post_id"}, {ProtoField: "reaction_type"}},
					FlagOptions: map[string]*autocliv1.FlagOptions{
						"reply_id":        {Name: "reply-id", Usage: "reply ID (0 = react to the post)"},
						"proof":           {Name: "proof", Usage: "ZK proof bytes (hex)"},
						"nullifier":       {Name: "nullifier", Usage: "nullifier bytes (hex)"},
						"merkle_root":     {Name: "merkle-root", Usage: "trust tree root bytes (hex)"},
						"min_trust_level": {Name: "min-trust-level", Usage: "proven minimum trust level"},
