...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		namesimulation.SimulateMsgRegisterName(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		namesimulation.SimulateMsgFileDispute(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		namesimulation.SimulateMsgResolveDispute(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
