...
var (
	...
	ErrTargetNotSet           = errors.Register(ModuleName, 1116, "name has no resolver target set")
	ErrNotTarget              = errors.Register(ModuleName, 1117, "sender is not the current target of this name")
	ErrTargetNotAccepted      = errors.Register(ModuleName, 1118, "target has not accepted this name")
	ErrCannotTransferDisputed = errors.Register(ModuleName, 1119, "cannot transfer a name with an active dispute")
	ErrRecipientNotMember     = errors.Register(ModuleName, 1120, "recipient is not an active x/rep member")
	ErrCannotTransferToSelf   = errors.Register(ModuleName, 1121, "cannot transfer name to current owner")
)
