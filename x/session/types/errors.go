...
var (
	...
	ErrSpendLimitTooHigh     = errors.Register(ModuleName, 1112, "requested spend limit exceeds max_spend_limit_amount")
	...
	ErrInvalidDenom          = errors.Register(ModuleName, 1121, "spend_limit denom does not match the chain's bond denom")
	...
	ErrInvalidMaxPerEpoch         = errors.Register(ModuleName, 1304, "max_per_epoch must parse as a non-negative sdk.Int")
	ErrMaxPerEpochBelowAmount     = errors.Register(ModuleName, 1305, "max_per_epoch below amount_per_period; one claim would breach the per-epoch ceiling")
	...
	ErrEpochCeilingExceeded       = errors.Register(ModuleName, 1310, "claim would exceed max_per_epoch for the current UTC day")
	...
	ErrDepositTooSmall            = errors.Register(ModuleName, 1511, "computed deposit is below params.min_oneshot_deposit")
	...
	ErrInvalidOneshotGasPrice     = errors.Register(ModuleName, 1516, "oneshot_gas_price must parse as a non-negative sdk.Dec")
