...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		forumsimulation.SimulateMsgBondSentinel(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgUnbondSentinel          = "op_weight_msg_forum"
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		forumsimulation.SimulateMsgUnbondSentinel(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgReportMember          = "op_weight_msg_forum"
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		forumsimulation.SimulateMsgReportMember(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgCosignMemberReport          = "op_weight_msg_forum"
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		forumsimulation.SimulateMsgCosignMemberReport(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgResolveMemberReport          = "op_weight_msg_forum"
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		forumsimulation.SimulateMsgResolveMemberReport(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgDefendMemberReport          = "op_weight_msg_forum"
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		forumsimulation.SimulateMsgDefendMemberReport(am.authKeeper, am.bankKeeper, am.keeper, simState.TxConfig),
	))
	const (
		opWeightMsgAppealGovAction          = "op_weight_msg_forum"
