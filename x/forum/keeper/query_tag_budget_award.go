...
func (q queryServer) ListTagBudgetAward(ctx context.Context, req *types.QueryAllTagBudgetAwardRequest) (*types.QueryAllTagBudgetAwardResponse, error) {
	...
	tagBudgetAwards, pageRes, err := query.CollectionPaginate(
		ctx,
		q.k.TagBudgetAward,
		req.Pagination,
	...
	return &types.QueryAllTagBudgetAwardResponse{TagBudgetAward: tagBudgetAwards, Pagination: pageRes}, nil
}
...
func (q queryServer) GetTagBudgetAward(ctx context.Context, req *types.QueryGetTagBudgetAwardRequest) (*types.QueryGetTagBudgetAwardResponse, error) {
	...
	tagBudgetAward, err := q.k.TagBudgetAward.Get(ctx, req.Id)
	if err != nil {
	...
	return &types.QueryGetTagBudgetAwardResponse{TagBudgetAward: tagBudgetAward}, nil
}
