...
// source: sparkdream/split/v1/share.proto
...
func (*Share) Descriptor() ([]byte, []int) {
	return fileDescriptor_7be4e413ecbdd5f0, []int{0}
}
...
func init() {
	proto.RegisterType((*Share)(nil), "sparkdream.split.v1.Share")
}

func init() { proto.RegisterFile("sparkdream/split/v1/share.proto", fileDescriptor_7be4e413ecbdd5f0) }

var fileDescriptor_7be4e413ecbdd5f0 = []byte{
	...
	0x2f, 0xce, 0x48, 0x2c, 0x4a, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x46, 0x28, 0xd0,
	0x03, 0x2b, 0xd0, 0x2b, 0x33, 0x54, 0xb2, 0xe4, 0x62, 0x0d, 0x06, 0xa9, 0x11, 0x92, 0xe0, 0x62,
	0x4f, 0x4c, 0x49, 0x29, 0x4a, 0x2d, 0x2e, 0x96, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x71,
	0x85, 0xc4, 0xb8, 0xd8, 0xca, 0x53, 0x33, 0xd3, 0x33, 0x4a, 0x24, 0x98, 0x14, 0x18, 0x35, 0x58,
	0x82, 0xa0, 0x3c, 0x27, 0xa3, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48,
	0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x92,
	0x40, 0x72, 0x4a, 0x05, 0xd4, 0x31, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0xa7, 0x18,
	0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xbd, 0x33, 0x2a, 0xb5, 0xad, 0x00, 0x00, 0x00,
}
...
func (m *Share) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Weight != 0 {
		i = encodeVarintShare(dAtA, i, uint64(m.Weight))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Address) > 0 {
		...
		i = encodeVarintShare(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
