...
type MsgCreateMarket struct {
	...
	InitialLiquidity string `protobuf:"bytes,3,opt,name=initial_liquidity,json=initialLiquidity,proto3" json:"initial_liquidity,omitempty"`
...
func (m *MsgCreateMarket) GetInitialLiquidity() string {
	if m != nil {
...
func (m *MsgTrade) GetAmountIn() string {
	if m != nil {
		return m.AmountIn
	}
	return ""
...
type MsgTradeResponse struct {
	SharesOut string `protobuf:"bytes,1,opt,name=shares_out,json=sharesOut,proto3" json:"shares_out,omitempty"`
}
...
func (m *MsgTradeResponse) GetSharesOut() string {
	if m != nil {
		return m.SharesOut
	}
	return ""
...
func (m *MsgWithdrawLiquidityResponse) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
var fileDescriptor_22856111bed8661a = []byte{
	...
	,
}
...
func (m *MsgCreateMarket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.InitialLiquidity) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.InitialLiquidity)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Symbol) > 0 {
...
func (m *MsgTradeResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SharesOut) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.SharesOut)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
