...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_cef9329c0cc56ffd, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cef9329c0cc56ffd, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "sparkdream.sparkdream.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "sparkdream.sparkdream.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("sparkdream/sparkdream/tx.proto", fileDescriptor_cef9329c0cc56ffd) }

var fileDescriptor_cef9329c0cc56ffd = []byte{
	// 320 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2b, 0x2e, 0x48, 0x2c,
	0xca, 0x4e, 0x29, 0x4a, 0x4d, 0xcc, 0xd5, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0x35, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xfc, 0x3a, 0xd5, 0xdc, 0x54, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sparkdream.sparkdream.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sparkdream.sparkdream.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "sparkdream.sparkdream.Msg",
	...
	Metadata: "sparkdream/sparkdream/tx.proto",
}
