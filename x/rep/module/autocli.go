	...
	return &autocliv1.ModuleOptions{
		Query: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				{
					RpcMethod:      "BondedRole",
					Use:            "bonded-role [role-type] [address]",
					Short:          "Query a BondedRole record by (role_type, address)",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "role_type"}, {ProtoField: "address"}},
				},
				{
					RpcMethod:      "BondedRolesByType",
					Use:            "bonded-roles-by-type [role-type]",
					Short:          "List BondedRole records for a role_type",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "role_type"}},
				},
				{
					RpcMethod:      "BondedRoleConfig",
					Use:            "bonded-role-config [role-type]",
					Short:          "Query the policy config for a role_type",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "role_type"}},
				},
				{
		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				{
					RpcMethod:      "BondRole",
					Use:            "bond-role [role-type] [amount]",
					Short:          "Bond DREAM against a role_type (generic bonded-role registration)",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "role_type"}, {ProtoField: "amount"}},
				},
				{
					RpcMethod:      "UnbondRole",
					Use:            "unbond-role [role-type] [amount]",
					Short:          "Unbond DREAM from a role_type (generic bonded-role withdrawal)",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "role_type"}, {ProtoField: "amount"}},
				},
				{
