...
import (
	...
	"sparkdream/x/shield/client/cli"
...
// (e.g., shielded-exec which takes an Any-typed inner message as JSON).
func (AppModule) GetTxCmd() *cobra.Command {
	return cli.GetTxCmd()
}

// BeginBlock handles auto-funding the shield module from the community pool.
func (am AppModule) BeginBlock(ctx context.Context) error {
	return am.keeper.BeginBlocker(ctx)
}

// EndBlock handles epoch advancement and batch execution.
